  ...
  initPools() {
    ...
    this.pool = {
      ...
      read: Pooling.createPool({
        ...
        validate: config.replicationPool.read.validate
      }, {
        Promise: config.replicationPool.read.Promise,
        testOnBorrow: true,
        returnToHead: true,
        autostart: false,
      ...
      write: Pooling.createPool({
        ...
        destroy: connection => this._disconnect(connection),
        validate: config.replicationPool.write.validate
      }, {
        Promise: config.replicationPool.write.Promise,
        testOnBorrow: true,
        returnToHead: true,
        autostart: false,
